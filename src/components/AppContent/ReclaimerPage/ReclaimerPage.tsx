        ...
        <div className={clsx(shared.bg, classes.reclaimerBg)}>
            <Container maxWidth="lg">
                ...
                <Typography paragraph>
                    ...
                    is a mobile game developed on Unity in C#, playable on both Android and iOS. The game was developed
                    for an elective course, CSCI-599: Mobile Social Games, at USC from January 2020 to May 2020. Players
                    start in a jail cell and have to escape the dungeon. Along the way, they can pick up weapons and
                    items in the environment, and fight medieval enemies that stand in the way of their escape.
                </Typography>
                <Typography paragraph>
                    ...
                    Blocking is accomplished by swiping with two fingers in the direction of the arrows. Failure to do
                    so results in getting hit. Players are rewarded to respond quickly; “perfect” blocks on-time result
                    in a powerful counterattack dealt to the enemy.
                </Typography>
                <Typography paragraph>
                    Players can get coins from the environment, opening chests, and defeating enemies. These coins can
                    be traded for stronger items in the dungeon’s shop.
                </Typography>
                <Typography paragraph>
                    My role on the team is the data analyst. For every event worth tracking (fighting enemies, combat
                    techniques, item purchases and usage, etc.), I created analytics hooks to funnel Unity Analytics
                    events into a dashboard. From these events, I delivered weekly reports detailing user activity
                    in-game, providing evidence-based feedback to class professors and the rest of my development team
